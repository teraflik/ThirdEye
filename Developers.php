...
<div class="container">
  ...
  <div data-column='3' class="at-grid">
    <div class="at-column">
      <div class="at-user">
        <div class="at-user__avatar"><img src="media/p.jpg"/></div>
    ...
    <div class="at-column">
      <div class="at-user">
        <div class="at-user__avatar"><img src="media/r.jpg"/></div>
    ...
    <div class="at-column">
      <div class="at-user">
        <div class="at-user__avatar"><img src="media/h.jpg"/></div>
    ...
    <div class="at-column">
      <div class="at-user">
        ...
        <div class="at-user__name">Mansi Choudhary</div>
        <div class="at-user__title">Volunteer</div>
        <ul class="at-social">
    ...
    <div class="at-column">
      <div class="at-user">
        <div class="at-user__avatar"><img src=""/></div>
        <div class="at-user__name">Sourin Chakrabarti</div>
        <div class="at-user__title">Volunteer</div>
        <ul class="at-social">
          <li class="at-social__item"><a href="">
              <svg viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
